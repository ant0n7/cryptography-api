...
//     *
//     * <p><a href="https://github.com/Ray784/Blowfish-S-boxes">Source (GitHub)</a></p>
//     */
...
//                    "3ac372e6"}};
//    //</editor-fold>
//    //<editor-fold desc="P-Array"
//    /**
//     * Digits of PI in hex (after 3.)
//     */
...
//        String hexA = hexToBin(a);
//        String hexB = hexToBin(b);
//
...
//
//        String hexResult = String.format("%8s", Long.toHexString(numberResult));
//
...
//
//        for (int i = 0; i < 8; i += 2) {
//            long column = Long.parseUnsignedLong(
//                    hexToBin(s.substring(i, i + 2)), 2);
...
//
//    /**
//     * Generate subkeys and set them in the P-array.
//     * @param key   Has to be a valid key size
//     */
//    private void initializeSubKeys(String key) {
//        int j = 0;
...
//    }
//
//    private String singleRound(String s, int roundNumber) {
//        String
...
//        String fLeft = f(left);
//
//        String xorResult = xor(fLeft, right);
//
//        System.out.println("Round " + roundNumber + " = " + right + left);
//
//        return right + left;
//    }
//
//    private String lastRound(String s) {
//        String right = s.substring(0, 8);
//        String left = s.substring(8, 16);
//        return xor(left, P[17]) + xor(right, P[16]);
//    }
//
